...
class TodoController {
     ...
     */
    public function add($task): bool {
        return $this->model->createTodo(task: $task);
    }
     ...
     */
    public function markAsCompleted($id): bool {
        return $this->model->updateTodoStatus(id: $id, is_completed: 1);
    }
    ...
    public function delete($id): bool {
        return $this->model->deleteTodo(id: $id);
    }
}